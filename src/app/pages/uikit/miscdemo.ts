            ...
            <div class="md:w-1/2">
                ...
                <div class="card">
                    ...
                    <p-avatargroup styleClass="mb-4">
                        ...
                        <p-avatar label="+2" shape="circle" size="large" [style]="{ 'background-color': 'var(--brand-green)', color: 'var(--brand-white)' }"></p-avatar>
                    </p-avatargroup>

                    <div class="font-semibold my-4">Label - Circle</div>
                    <p-avatar class="mr-2" label="P" size="xlarge" shape="circle"></p-avatar>
                    <p-avatar class="mr-2" label="V" size="large" [style]="{ 'background-color': 'var(--brand-red)', color: 'var(--brand-white)' }" shape="circle"></p-avatar>
                    <p-avatar class="mr-2" label="U" [style]="{ 'background-color': 'var(--brand-green)', color: 'var(--brand-white)' }" shape="circle"></p-avatar>
